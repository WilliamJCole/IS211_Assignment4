#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""A module that contains searching algorithms."""
...
def sequential_search(a_list, item):
    """Sequential Search.
    Args:
        a_list(list): data that is to be searched.
        item(various): an item or value to be searched.
    Returns:
        (Tuple): processed time in seconds, & boolean value of items existance.
    Examples:
...
def random_list(avg_time):
    """Generator for a list of algorithm searches."""
    my_list = []
